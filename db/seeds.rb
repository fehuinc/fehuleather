...
# Raw Ring ######################################
raw_ring = rings.products.create! name: "Raw Ring", description: "Raw Ring Description", show_retail: true, show_wholesale: true, price_retail: 100, price_wholesale: 50, ypos: 23
...
raw_ring_leather_color.variants.create! name: "Red", show_retail: true, show_wholesale: true
raw_ring_leather_color.variants.create! name: "Yellow", show_retail: true, show_wholesale: true
...
# C&C Bracelet ##################################
cc_bracelet = bracelets.products.create! name: "Coffee & Crystals Bracelet", description: "C&C Bracelet Description", show_retail: true, show_wholesale: true, price_retail: 100, price_wholesale: 50, ypos: 18
...
# Wrap Cuff #####################################
wrap_cuff = bracelets.products.create! name: "Wrap Cuff", description: "Wrap Cuff Description", show_retail: true, show_wholesale: true, price_retail: 100, price_wholesale: 50, ypos: 18
...
wrap_cuff_color.variants.create! name: "Bark", show_retail: true, show_wholesale: true
wrap_cuff_color.variants.create! name: "Green", show_retail: true, show_wholesale: true
wrap_cuff_color.variants.create! name: "Pink", show_retail: true, show_wholesale: true
wrap_cuff_color.variants.create! name: "Pumpkin", show_retail: true, show_wholesale: true
wrap_cuff_color.variants.create! name: "Slate", show_retail: true, show_wholesale: true
wrap_cuff_color.variants.create! name: "Turq", show_retail: true, show_wholesale: true
wrap_cuff_color.variants.create! name: "Orangesicle", show_retail: true, show_wholesale: true
wrap_cuff_color.variants.create! name: "Violet", show_retail: true, show_wholesale: true
...
# Fuzzy Cuff ####################################
fuzzy_cuff = bracelets.products.create! name: "Fuzzy Cuff", description: "Fuzzy Cuff Description", show_retail: true, show_wholesale: true, price_retail: 100, price_wholesale: 50, ypos: 33
